...
const services: Service[] = [
  {
    ...
    price: "от 50 000 ₽",
    result:
      "Подходит для быстрого запуска продукта, услуги или рекламной кампании",
    popular: true,
  },

  {
    ...
    price: "от 120 000 ₽",
    result:
      "Помогает получать заявки и формировать доверие к бизнесу в интернете",
    popular: true,
  },

  {
    ...
    price: "от 60 000 ₽",
    result:
      "Снижает количество отказов и увеличивает число заявок с текущего трафика",
    popular: true,
  },

  {
    ...
    price: "от 160 000 ₽",
    result:
      "Полноценный онлайн-магазин для продаж без ограничений маркетплейсов",
    popular: true,
  },

  {
    ...
    price: "от 150 000 ₽",
    result:
      "Подходит для быстрого запуска MVP без затрат на две отдельные команды",
  },

  {
    ...
    result:
      "Проект остается стабильным, безопасным и актуальным после запуска",
  },
];
